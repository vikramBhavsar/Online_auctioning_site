											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
																<form action="#" method="post">
																	<fieldset>
																		...
																		<input type="hidden" name="pid" value="<?php echo $pname?>" />	
																		<input type="hidden" name="pid" value="<?php echo $username?>" />	
																		<input type="hidden" name="pid" value="<?php echo $startingbid?>" />	
																		<input type="hidden" name="pid" value="<?php echo $emailid?>" />	
																		<input type="hidden" name="pid" value="<?php echo $phone?>" />	
																		<input type="hidden" name="pid" value="<?php echo $address?>" />	
																		<input type="hidden" name="pid" value="<?php echo $typename?>" />	
