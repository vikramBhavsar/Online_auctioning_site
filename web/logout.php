		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method='POST'>
				...
				<div style="margin-left:130px;">
	                <span ><h1><b>Confirm Logout?</b></h1></span>
				</div>
				<br><br>
				<div  data-validate="Please enter your username">
				<button class="contact100-form-btn" name='logoutbtn' style="margin-left:200px;">
						<span>
				...
				<button class="contact100-form-btn" name='mainpagebtn' style="margin-left:200px;">
						<span>
							<i class="fa fa-paper-plane-o m-r-6" aria-hidden="true"></i>
							Go back
						</span>
